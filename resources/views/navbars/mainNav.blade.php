    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="{{ action('UserController@index') }}">Uporabniki</a></li>
                <li><a href="{{ action('ArticleController@index') }}">Novice</a></li>
                {{--<li><a href="{{ action('NewsController@index') }}">Novice</a></li>--}}
                <li><a href="{{ action('ProgramController@index') }}">programi</a></li>
                <li><a href="{{ action('ReservationController@index') }}">rezervacije</a></li>
            </ul>
